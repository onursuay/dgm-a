  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 60% at 50% 60%, rgba(26,111,255,0.05) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 lg:px-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-[#6688aa] max-w-xl mx-auto text-lg leading-relaxed">
        ...
        >
          ...
          <div
            ...
            style={{ borderBottom: "1px solid rgba(26,111,255,0.12)" }}
          >
            <div className="text-xs font-bold tracking-[0.2em] uppercase text-[#38b6ff]">
              Metric
            </div>
            <div className="text-xs font-bold tracking-[0.2em] uppercase text-[#38b6ff] text-center">
              Before DNF
            </div>
            <div className="text-xs font-bold tracking-[0.2em] uppercase text-[#38b6ff] text-center">
              After DNF
              ...
              style={{
                borderBottom:
                  i < testResults.length - 1
                    ? "1px solid rgba(26,111,255,0.07)"
                    : "none",
              }}
            >
              <div className="text-sm font-semibold text-[#e8f0ff]">{r.label}</div>
              <div className="text-sm text-center font-mono" style={{ color: "#ef4444" }}>
                {r.before}
              </div>
              <div className="text-sm text-center font-mono text-[#38b6ff]">
                {r.after}
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10">
          {demoTypes.map((d, i) => {
            ...
            return (
              ...
              >
                <div
                  className="w-12 h-12 rounded-xl flex items-center justify-center shrink-0 text-[#38b6ff]"
                  style={{
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2 flex-wrap">
                    <h4 className="text-sm font-bold text-[#e8f0ff]">{d.title}</h4>
                    <span
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-[#3a5a7a] mt-3">
