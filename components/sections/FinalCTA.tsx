    ...
    >
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-6 lg:px-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <a href="mailto:info@dnf-technology.de"
            className="btn-fire px-10 py-5 rounded-full text-base w-full sm:w-auto font-bold">
            Request Information
          </a>
          <a href="#demonstrations"
            className="btn-outline-fire px-10 py-5 rounded-full text-base w-full sm:w-auto">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 px-10 py-5 rounded-full text-base font-semibold border border-green-800/40 text-green-400 hover:bg-green-950/20 hover:border-green-700/60 transition-all w-full sm:w-auto"
          >
