  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 70% 60% at 30% 50%, rgba(26,111,255,0.04) 0%, transparent 60%), radial-gradient(ellipse 50% 50% at 80% 50%, rgba(56,182,255,0.04) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 lg:px-10">
          ...
          {forestFacts.map((f) => {
            ...
            return (
              ...
              >
                ...
                <div className="text-xs text-[#3a5a7a] leading-tight">{f.label}</div>
              </div>
            );
          })}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            <div
              className="w-12 h-12 rounded-xl flex items-center justify-center mb-4 text-[#38b6ff]"
              style={{
            ...
            <p className="text-sm text-[#6688aa] leading-relaxed mb-5">
            ...
            <ul className="space-y-2">
              {wildlifePoints.map((p) => (
                <li key={p} className="flex items-center gap-2 text-xs text-[#6688aa]">
                  <span className="text-[#38b6ff] text-xs font-bold">▸</span>
                  {p}
                </li>
              ))}
            </ul>
