          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div
                ...
                style={{ color: "rgba(26,111,255,0.08)" }}
              >
                {step.phase}
              </div>
              ...
              <div className="relative z-10">
                {/* Icon */}
                <div
                  className="w-14 h-14 rounded-2xl flex items-center justify-center mb-5 text-[#38b6ff]"
                  style={{
                ...
                {/* Sub-label */}
                <div className="text-xs font-bold tracking-[0.2em] uppercase text-[#38b6ff] mb-2 opacity-80">
                  {step.sub}
                </div>
                ...
                <div
                  ...
                  style={{ borderColor: "rgba(26,111,255,0.1)" }}
                >
