...
const riskBars: RiskBar[] = [
  ...
  },
  {
    ...
    statusColor: "#38b6ff",
    width: "24%",
    barColor: "from-[#1a6fff] to-[#38b6ff]",
  },
  {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 60% at 70% 50%, rgba(26,111,255,0.05) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
          ...
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-black text-[#e8f0ff] leading-tight mb-5">
              When the Stakes
              <br />
              <span className="text-ice-gradient">Are Measured in Millions.</span>
            </h2>
            <p className="text-[#6688aa] text-base leading-relaxed mb-5">
            ...
            <p className="text-[#6688aa] text-sm leading-relaxed mb-7">
            ...
            <div className="grid grid-cols-3 gap-3 mb-7">
              {sectors.map((s) => {
                ...
                return (
                  ...
                  >
                    <div className="w-8 h-8 mb-2 text-[#38b6ff]">
                      <SIcon className="w-8 h-8" />
                    </div>
                    <div className="text-[10px] text-[#3a5a7a] leading-tight font-medium">
                      {s.label}
                    </div>
                  </div>
                );
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              <div
                className="w-14 h-14 rounded-xl flex items-center justify-center text-[#38b6ff] shrink-0"
                style={{
              ...
              <div>
                <div className="text-lg font-black text-[#e8f0ff]">Industrial Shield</div>
                <div className="text-xs text-[#38b6ff] font-medium mt-0.5">
                  DNF Industrial Fire Containment Protocol
                </div>
                <div className="text-xs text-[#6688aa] mt-1">
            ...
            >
              <div className="text-xs font-bold tracking-[0.2em] uppercase text-[#38b6ff] mb-5">
                ...
                {riskBars.map((rb, i) => (
                  <div key={i}>
                    <div className="flex justify-between text-xs mb-1.5">
                      <span className="text-[#6688aa]">{rb.label}</span>
            ...
            {riskCards.map((rc, i) => (
              ...
              >
                <div
                  ...
                  style={{
                    background: "linear-gradient(to bottom, #1a6fff, #38b6ff)",
                  }}
                />
                <div>
                  <div className="text-sm font-bold text-[#e8f0ff] mb-1">{rc.title}</div>
                  <div className="text-xs text-[#6688aa] leading-relaxed">{rc.desc}</div>
                </div>
              </div>
            ))}
          </div>
