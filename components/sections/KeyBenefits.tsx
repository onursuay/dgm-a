  ...
  return (
    ...
    >
      <div className="absolute right-0 top-0 bottom-0 w-80 pointer-events-none"
        style={{ background: "linear-gradient(270deg, rgba(180,40,0,0.06) 0%, transparent 100%)" }} />
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 lg:px-10">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 card-premium rounded-2xl p-10 border border-orange-900/10 relative overflow-hidden">
              <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start">
                <div>
                  <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-[#ff6b00]"
                    style={{ background: "rgba(255,107,0,0.08)", border: "1px solid rgba(255,107,0,0.2)" }}>
                    <B0Icon className="w-7 h-7" />
                  </div>
                  <h3 className="text-2xl font-black text-[#f5f0eb] mb-3">{benefits[0].title}</h3>
                  <p className="text-[#a8a0a0] text-base leading-relaxed">{benefits[0].desc}</p>
                </div>
                <div className="shrink-0 text-center border border-orange-900/20 rounded-2xl p-6 min-w-[140px] bg-orange-950/10">
                  <div className="text-3xl font-black text-fire-gradient">{benefits[0].metric}</div>
                  <div className="text-xs text-[#6a6060] mt-2 leading-tight">{benefits[0].metricLabel}</div>
                </div>
              </div>
            </div>
            <div className="card-premium rounded-2xl p-7 border border-orange-900/10 flex flex-col justify-between">
              <div>
                <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4 text-[#ff6b00]"
                  style={{ background: "rgba(255,107,0,0.08)", border: "1px solid rgba(255,107,0,0.2)" }}>
                  <B1Icon className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold text-[#f5f0eb] mb-2">{benefits[1].title}</h3>
                <p className="text-sm text-[#a8a0a0] leading-relaxed">{benefits[1].desc}</p>
              </div>
              <div className="mt-4 border-t border-orange-900/15 pt-4">
                <div className="text-2xl font-black text-fire-gradient">{benefits[1].metric}</div>
                <div className="text-xs text-[#6a6060]">{benefits[1].metricLabel}</div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {benefits.slice(2, 5).map((b, i) => {
              const BIcon = b.Icon;
              return (
                <div key={i} className="card-premium rounded-2xl p-7 border border-orange-900/10 flex flex-col justify-between">
                  <div>
                    <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4 text-[#ff6b00]"
                      style={{ background: "rgba(255,107,0,0.08)", border: "1px solid rgba(255,107,0,0.2)" }}>
                      <BIcon className="w-6 h-6" />
                    </div>
                    <h3 className="text-lg font-bold text-[#f5f0eb] mb-2">{b.title}</h3>
                    <p className="text-sm text-[#a8a0a0] leading-relaxed">{b.desc}</p>
                  </div>
                  <div className="mt-4 border-t border-orange-900/15 pt-4">
                    <div className="text-xl font-black text-fire-gradient">{b.metric}</div>
                    <div className="text-xs text-[#6a6060]">{b.metricLabel}</div>
                  </div>
                </div>
              );
            })}
          ...
          <div className="card-premium rounded-2xl p-10 border border-orange-900/10 relative overflow-hidden">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              <div className="flex-1">
                ...
                <h3 className="text-2xl font-black text-[#f5f0eb] mb-3">{benefits[5].title}</h3>
                <p className="text-[#a8a0a0] text-base leading-relaxed">{benefits[5].desc}</p>
              </div>
              <div className="shrink-0 text-center border border-orange-900/20 rounded-2xl p-6 min-w-[140px] bg-orange-950/10">
                <div className="text-3xl font-black text-fire-gradient">{benefits[5].metric}</div>
                <div className="text-xs text-[#6a6060] mt-2 leading-tight">{benefits[5].metricLabel}</div>
              </div>
            </div>
          </div>
        </div>
