  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 60% at 30% 50%, rgba(26,111,255,0.05) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-3 mb-6">
              {targets.map((t) => {
                ...
                return (
                  ...
                  >
                    <div className="w-8 h-8 mx-auto mb-2 text-[#38b6ff]">
            ...
            <p className="text-[#6688aa] text-sm leading-relaxed mb-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              <div className="w-14 h-14 rounded-xl flex items-center justify-center text-[#38b6ff] shrink-0"
                style={{ background: "rgba(26,111,255,0.1)", border: "1px solid rgba(26,111,255,0.2)" }}>
                <IconCity className="w-8 h-8" />
              </div>
              <div>
                <div className="text-lg font-black text-[#e8f0ff]">Urban Shield Program</div>
                <div className="text-xs text-[#38b6ff] font-medium mt-0.5">
                  DNF Municipal Protection Initiative
                </div>
                <div className="text-xs text-[#6688aa] mt-1 leading-relaxed">
            ...
            {statCards.map((sc, i) => (
              ...
              >
                ...
                <div className="text-xs font-bold tracking-widest uppercase text-[#38b6ff] mb-3">
                  {sc.label}
                </div>
                <p className="text-xs text-[#6688aa] leading-relaxed">{sc.desc}</p>
              </div>
            ))}
