  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 70% 50% at 50% 50%, rgba(26,111,255,0.05) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 lg:px-10">
          ...
          {pillars.map((pillar, i) => (
            ...
            >
              ...
              <div
                ...
                style={{ color: "rgba(26,111,255,0.07)" }}
              >
                {pillar.number}
              </div>
              ...
              {/* Number badge */}
              <div
                className="inline-flex items-center justify-center w-9 h-9 rounded-lg text-xs font-black text-[#38b6ff] mb-6 shrink-0"
                style={{
              ...
              {/* Icon */}
              <div
                className="w-14 h-14 rounded-xl flex items-center justify-center mb-6 text-[#38b6ff] shrink-0"
                style={{
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-[#e8f0ff] mb-3">{pillar.title}</h3>
              ...
              <div
                ...
                style={{ borderColor: "rgba(26,111,255,0.12)" }}
              >
                <div className="text-2xl font-black text-ice-gradient">{pillar.stat}</div>
                <div className="text-xs text-[#3a5a7a] mt-1">{pillar.statLabel}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-14 flex items-center gap-4">
          <div className="flex-1 h-px" style={{ background: "rgba(26,111,255,0.1)" }} />
          <div className="text-xs text-[#3a5a7a] tracking-widest uppercase font-medium">
            How it works
          </div>
          <div className="flex-1 h-px" style={{ background: "rgba(26,111,255,0.1)" }} />
        </div>
