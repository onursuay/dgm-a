  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 60% at 50% 40%, rgba(26,111,255,0.04) 0%, transparent 70%)",
        }}
      />
          ...
          {useCases.map((uc, i) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div
                  className="w-10 h-10 rounded-xl flex items-center justify-center mb-3 text-[#38b6ff]"
                  style={{
